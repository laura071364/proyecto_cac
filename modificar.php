...
if($_POST){
    ...
    $sql = "UPDATE `proyecto` SET `titulo` = '$nombre_proyecto' , `imagen` = '$imagen', `descripcion` = '$descripcion' WHERE `proyecto`.`id` = '$id';";
                    ...
                    <div class="card-body">
                        ...
                        <form action="#" method="post" enctype="multipart/form-data">
                            <div>
                                ...
                                <input required class="form-control" type="text" name="titulo" id="titulo" value="<?php echo $fila['titulo']; ?>">
                            </div>
